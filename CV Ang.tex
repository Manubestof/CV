...
% \vspace{10pt} % Adjust this value to control the space below the internship text
...
\vspace{7pt} % Reduce space between entries
\noindent
\begin{tabularx}{\textwidth}{@{}Xr@{}}
...
\vspace{7pt} % Adjust space between entries
\noindent
\begin{tabularx}{\textwidth}{@{}Xr@{}}
